...
public class UserDetailsServiceImpl implements UserDetailsService {
     ...
     * @param user    用户账号
     * @param request 请求
     * @return 用户登录信息 UserDetailDTO，该用户信息类实现了security自带的UserDetail接口
     */
    //todo 后端控制层不用写login接口，直接在重写security自带的UserDetailsService接口封装了
    public UserDetailDTO convertUserDetail(UserAuth user, HttpServletRequest request) {
        ...
        // 查询账号点赞信息
        //todo redis redisTemplate.opsForSet().members(key); 查询账号点赞、评论、文章信息
