...
-- ----------------------------
INSERT INTO `tb_article` VALUES (55, 1, 187, 'https://static.talkxj.com/articles/3dffb2fcbd541886616ab54c92570de3.jpg', '测试文章111', '恭喜你成功运行博客，开启你的文章之旅吧。', 1, '', 0, 0, 1, '2022-01-24 23:33:56', '2022-08-07 20:51:12');
...
) ENGINE = InnoDB AUTO_INCREMENT = 860 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of tb_article_tag
-- ----------------------------
INSERT INTO `tb_article_tag` VALUES (859, 55, 29);
...
-- ----------------------------
INSERT INTO `tb_category` VALUES (187, '学习', '2022-01-24 23:33:56', '2022-08-07 19:38:58');
INSERT INTO `tb_category` VALUES (188, '心情', '2022-08-07 19:40:20', NULL);
INSERT INTO `tb_category` VALUES (189, '笔记', '2022-08-07 19:41:07', NULL);
...
CREATE TABLE `tb_message`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3940 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
INSERT INTO `tb_message` VALUES (3939, '用户1556259551760633857', 'http://upload.asukasuna.xyz/config/f68e183c5cc853f01dc1651c809494e2.jpg', '留下脚印', '127.0.0.1', '', 8, 1, '2022-08-07 20:45:20', NULL);
...
CREATE TABLE `tb_operation_log`  (
  ...
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1097 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
INSERT INTO `tb_operation_log` VALUES (1084, '分类模块', '新增或修改', '/admin/categories', 'com.minzheng.blog.controller.CategoryController.saveOrUpdateCategory', '添加或修改分类', '[{\"categoryName\":\"Java\",\"id\":187}]', 'POST', '{\"code\":20000,\"flag\":true,\"message\":\"操作成功\"}', 1, '管理员', '127.0.0.1', '', '2022-08-07 19:37:47', NULL);
INSERT INTO `tb_operation_log` VALUES (1085, '标签模块', '新增或修改', '/admin/tags', 'com.minzheng.blog.controller.TagController.saveOrUpdateTag', '添加或修改标签', '[{\"id\":29,\"tagName\":\"学习\"}]', 'POST', '{\"code\":20000,\"flag\":true,\"message\":\"操作成功\"}', 1, '管理员', '127.0.0.1', '', '2022-08-07 19:37:58', NULL);
INSERT INTO `tb_operation_log` VALUES (1086, '标签模块', '新增或修改', '/admin/tags', 'com.minzheng.blog.controller.TagController.saveOrUpdateTag', '添加或修改标签', '[{\"id\":29,\"tagName\":\"Java\"}]', 'POST', '{\"code\":20000,\"flag\":true,\"message\":\"操作成功\"}', 1, '管理员', '127.0.0.1', '', '2022-08-07 19:38:44', NULL);
INSERT INTO `tb_operation_log` VALUES (1087, '分类模块', '新增或修改', '/admin/categories', 'com.minzheng.blog.controller.CategoryController.saveOrUpdateCategory', '添加或修改分类', '[{\"categoryName\":\"学习\",\"id\":187}]', 'POST', '{\"code\":20000,\"flag\":true,\"message\":\"操作成功\"}', 1, '管理员', '127.0.0.1', '', '2022-08-07 19:38:58', NULL);
INSERT INTO `tb_operation_log` VALUES (1088, '标签模块', '新增或修改', '/admin/tags', 'com.minzheng.blog.controller.TagController.saveOrUpdateTag', '添加或修改标签', '[{\"tagName\":\"MySQL\"}]', 'POST', '{\"code\":20000,\"flag\":true,\"message\":\"操作成功\"}', 1, '管理员', '127.0.0.1', '', '2022-08-07 19:39:13', NULL);
INSERT INTO `tb_operation_log` VALUES (1089, '标签模块', '新增或修改', '/admin/tags', 'com.minzheng.blog.controller.TagController.saveOrUpdateTag', '添加或修改标签', '[{\"tagName\":\"Redis\"}]', 'POST', '{\"code\":20000,\"flag\":true,\"message\":\"操作成功\"}', 1, '管理员', '127.0.0.1', '', '2022-08-07 19:39:22', NULL);
INSERT INTO `tb_operation_log` VALUES (1090, '标签模块', '新增或修改', '/admin/tags', 'com.minzheng.blog.controller.TagController.saveOrUpdateTag', '添加或修改标签', '[{\"tagName\":\"RabbitMQ\"}]', 'POST', '{\"code\":20000,\"flag\":true,\"message\":\"操作成功\"}', 1, '管理员', '127.0.0.1', '', '2022-08-07 19:39:47', NULL);
INSERT INTO `tb_operation_log` VALUES (1091, '标签模块', '新增或修改', '/admin/tags', 'com.minzheng.blog.controller.TagController.saveOrUpdateTag', '添加或修改标签', '[{\"tagName\":\"SpringBoot\"}]', 'POST', '{\"code\":20000,\"flag\":true,\"message\":\"操作成功\"}', 1, '管理员', '127.0.0.1', '', '2022-08-07 19:39:58', NULL);
INSERT INTO `tb_operation_log` VALUES (1092, '标签模块', '新增或修改', '/admin/tags', 'com.minzheng.blog.controller.TagController.saveOrUpdateTag', '添加或修改标签', '[{\"tagName\":\"SpringCloud\"}]', 'POST', '{\"code\":20000,\"flag\":true,\"message\":\"操作成功\"}', 1, '管理员', '127.0.0.1', '', '2022-08-07 19:40:06', NULL);
INSERT INTO `tb_operation_log` VALUES (1093, '分类模块', '新增或修改', '/admin/categories', 'com.minzheng.blog.controller.CategoryController.saveOrUpdateCategory', '添加或修改分类', '[{\"categoryName\":\"心情\"}]', 'POST', '{\"code\":20000,\"flag\":true,\"message\":\"操作成功\"}', 1, '管理员', '127.0.0.1', '', '2022-08-07 19:40:20', NULL);
INSERT INTO `tb_operation_log` VALUES (1094, '分类模块', '新增或修改', '/admin/categories', 'com.minzheng.blog.controller.CategoryController.saveOrUpdateCategory', '添加或修改分类', '[{\"categoryName\":\"笔记\"}]', 'POST', '{\"code\":20000,\"flag\":true,\"message\":\"操作成功\"}', 1, '管理员', '127.0.0.1', '', '2022-08-07 19:41:08', NULL);
INSERT INTO `tb_operation_log` VALUES (1095, '文章模块', '新增或修改', '/admin/articles', 'com.minzheng.blog.controller.ArticleController.saveOrUpdateArticle', '添加或修改文章', '[{\"articleContent\":\"恭喜你成功运行博客，开启你的文章之旅吧。\",\"articleCover\":\"https://static.talkxj.com/articles/3dffb2fcbd541886616ab54c92570de3.jpg\",\"articleTitle\":\"测试文章\",\"categoryName\":\"学习\",\"id\":54,\"isTop\":0,\"originalUrl\":\"\",\"status\":1,\"tagNameList\":[],\"type\":1}]', 'POST', '{\"code\":20000,\"flag\":true,\"message\":\"操作成功\"}', 1, '管理员', '127.0.0.1', '', '2022-08-07 20:51:10', NULL);
INSERT INTO `tb_operation_log` VALUES (1096, '文章模块', '新增或修改', '/admin/articles', 'com.minzheng.blog.controller.ArticleController.saveOrUpdateArticle', '添加或修改文章', '[{\"articleContent\":\"恭喜你成功运行博客，开启你的文章之旅吧。\",\"articleCover\":\"https://static.talkxj.com/articles/3dffb2fcbd541886616ab54c92570de3.jpg\",\"articleTitle\":\"测试文章\",\"categoryName\":\"学习\",\"id\":54,\"isTop\":0,\"originalUrl\":\"\",\"status\":1,\"tagNameList\":[],\"type\":1}]', 'POST', '{\"code\":20000,\"flag\":true,\"message\":\"操作成功\"}', 1, '管理员', '127.0.0.1', '', '2022-08-07 20:51:12', NULL);
...
-- Records of tb_page
-- ----------------------------
INSERT INTO `tb_page` VALUES (1, '首页', 'home', 'http://oldfriendblog.oss-cn-beijing.aliyuncs.com/config/b14170032850bf138155ac43691c6b5b.jpg', '2021-08-07 10:32:36', '2021-12-27 12:19:01');
...
-- Records of tb_tag
-- ----------------------------
INSERT INTO `tb_tag` VALUES (29, 'Java', '2022-01-24 23:33:57', '2022-08-07 19:38:44');
INSERT INTO `tb_tag` VALUES (30, 'MySQL', '2022-08-07 19:39:13', NULL);
INSERT INTO `tb_tag` VALUES (31, 'Redis', '2022-08-07 19:39:22', NULL);
INSERT INTO `tb_tag` VALUES (32, 'RabbitMQ', '2022-08-07 19:39:47', NULL);
INSERT INTO `tb_tag` VALUES (33, 'SpringBoot', '2022-08-07 19:39:58', NULL);
INSERT INTO `tb_tag` VALUES (34, 'SpringCloud', '2022-08-07 19:40:06', NULL);
...
-- Records of tb_talk
-- ----------------------------
INSERT INTO `tb_talk` VALUES (50, 1, '为什么会显示权限不足啊，做梦都在想着怎么解决<img src=\"https://static.talkxj.com/emoji/wuyan.jpg\" width=\"24\" height=\"24\" alt=\"[捂眼]\" style=\"margin: 0 1px;vertical-align: text-bottom\">', NULL, 1, 1, '2022-08-07 19:34:13', NULL);
...
-- ----------------------------
INSERT INTO `tb_unique_view` VALUES (534, 1, '2022-08-07 00:00:01', NULL);
...
-- ----------------------------
INSERT INTO `tb_user_auth` VALUES (1, 1, 'admin@qq.com', '$2a$10$EuTo2IGewQQDWw3C4fW3Cutbmz14wacsSnALmk1H6rlri4K01.0c2', 1, '0:0:0:0:0:0:0:1', '', '2021-08-12 15:43:18', '2022-08-09 23:12:18', '2022-08-09 23:12:18');
INSERT INTO `tb_user_auth` VALUES (995, 1005, 'xiaainy@163.com', '$2a$10$EuTo2IGewQQDWw3C4fW3Cutbmz14wacsSnALmk1H6rlri4K01.0c2', 1, '61.222.202.239', '台湾省', '2022-01-27 10:58:11', '2022-01-27 10:58:12', '2022-01-27 10:58:12');
INSERT INTO `tb_user_auth` VALUES (996, 1006, '870900860@qq.com', '$2a$10$EuTo2IGewQQDWw3C4fW3Cutbmz14wacsSnALmk1H6rlri4K01.0c2', 1, '127.0.0.1', '', '2022-08-07 20:42:48', '2022-08-07 21:49:15', '2022-08-07 21:49:15');
...
INSERT INTO `tb_user_info` VALUES (1006, '870900860@qq.com', '萌新1号', 'https://static.talkxj.com/avatar/user.png', '小萌新', NULL, 0, '2022-08-07 20:42:46', '2022-08-07 21:46:47');
...
-- ----------------------------
INSERT INTO `tb_website_config` VALUES (1, '{\"alipayQRCode\":\"\",\"gitee\":\"https://gitee.com/lynnluz\",\"github\":\"https://github.com/Lynn-Lu-zl\",\"isChatRoom\":1,\"isCommentReview\":0,\"isEmailNotice\":1,\"isMessageReview\":0,\"isMusicPlayer\":1,\"isReward\":1,\"qq\":\"870900860\",\"socialLoginList\":[\"qq\",\"weibo\",\"github\"],\"socialUrlList\":[\"qq\",\"github\",\"gitee\"],\"touristAvatar\":\"https://static.talkxj.com/photos/0bca52afdb2b9998132355d716390c9f.png\",\"userAvatar\":\"http://upload.asukasuna.xyz/config/f68e183c5cc853f01dc1651c809494e2.jpg\",\"websiteAuthor\":\"提灯寻秃兔\",\"websiteAvatar\":\"http://upload.asukasuna.xyz/config/f68e183c5cc853f01dc1651c809494e2.jpg\",\"websiteCreateTime\":\"2022-6-10\",\"websiteIntro\":\"That which does not kill us makes us stronger\",\"websiteName\":\"LynnLu Blog\",\"websiteNotice\":\"白昼之光，岂知夜色之深\",\"websiteRecordNo\":\"备案号\",\"websocketUrl\":\"ws://127.0.0.1:8080/websocket\",\"weiXinQRCode\":\"\"}', '2021-08-09 19:37:30', '2022-01-18 00:25:47');
