  ...
  methods: {
    ...
    weiboLogin() {
      ...
      giteeLogin() {
          ...
          // );
        window.open(
            "https://gitee.com/oauth/authorize?client_id=abdbbec7723f60e014b87ecccdc5502b5b637526c0ead56ee620e19c72652da7&redirect_uri=http://124.71.220.35:80/oauth/login/gitee&response_type=code&state=1"
        );
      }
